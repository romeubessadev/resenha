...
const pt = {
  ...
  'profile.you': 'Você',
  'profile.notifPermissionBody': 'Libera as notificações nas configurações do sistema pra receber avisos do rolê.',
  ...
  'profile.upgradeHelper': 'Libera IA, exportes e rolês ilimitados',
  'profile.brosPlusPlan': 'Bros+',
  'profile.activeHelper': 'Todas as funções liberadas',
  'profile.plan.cta': 'Ver planos',
  'profile.pushTitle': 'Notificações do rolê',
  ...
  'profile.logoutConfirmBody': 'Você vai precisar entrar de novo pra ver seus rolês.',
  ...
  'wallet.multiGroupSummary': '{groups} rolês · {items} movimentações',
  ...
  'groups.balanceCaption': 'somando todos os seus rolês ativos',
  'groups.active': 'Ativos',
  'groups.archived': 'Arquivados',
  'groups.searchPlaceholder': 'Buscar rolê ou pessoa',
  'groups.loadErrorTitle': 'Não deu pra carregar seus rolês.',
  'groups.retry': 'Tentar de novo',
  'groups.emptyActiveTitle': 'Você ainda não tem rolês',
  'groups.emptyArchivedTitle': 'Nenhum rolê arquivado',
  'groups.emptyActiveSubtitle': 'Toca no + pra criar seu primeiro rolê, ou usa o QR pra entrar num.',
  'groups.emptyArchivedSubtitle': 'Os rolês encerrados aparecem aqui.',
  'groups.emptySearchTitle': 'Nenhum rolê encontrado',
  'groups.emptySearchSubtitle': 'Tenta outro nome ou pessoa.',
  'groups.createCta': 'Criar novo rolê',
  'groups.createCtaSubtitle': 'Chama a galera e começa a rachar',
  'groups.notFoundTitle': 'Rolê não encontrado',
  'groups.notFoundBody': 'Esse QR code não é de nenhum rolê. Confere com quem te chamou.',
  'groups.joinFailedTitle': 'Não deu pra entrar no rolê',
  ...
  'common.groupPhotoTitle': 'Foto do rolê',
  ...
  'groupSheet.nameLabel': 'Nome do rolê',

  'editGroup.title': 'Editar rolê',
  'editGroup.saveFailedTitle': 'Não deu pra salvar',
  'editGroup.submit': 'Salvar alterações',

  'createRole.title': 'Criar novo rolê',
  'createRole.createdTitle': 'Rolê criado!',
  'createRole.namePlaceholder': 'Ex: Churras de sábado',
  'createRole.creating': 'Criando...',
  'createRole.submit': 'Criar rolê',
  'createRole.createFailedTitle': 'Não deu pra criar o rolê',
  'createRole.createdButPhotoFailedTitle': 'Rolê criado',
  ...
  'invite.codeLabel': 'Código do rolê',
  'invite.shareMessage': 'Bora rachar o rolê "{name}" no Bros! Entra no app e usa o código {code}.',

  'groupOptions.title': 'Opções do rolê',
  'groupOptions.members': 'Participantes',
  'groupOptions.insights': 'Insights',
  'groupOptions.insightsHint': 'gastos por categoria',
  'groupOptions.unarchive': 'Desarquivar rolê',
  'groupOptions.archive': 'Arquivar rolê',
  'groupOptions.archiveHint': 'só pra você',

  'leaveGroup.action': 'Sair do rolê',
  'leaveGroup.leaving': 'Saindo...',
  'leaveGroup.blockedTitle': 'Acerte suas contas antes',
  'leaveGroup.blockedReceivable': 'Você ainda tem {amount} pra receber nesse rolê. Peça pra galera acertar antes de sair — assim ninguém fica no prejuízo.',
  'leaveGroup.blockedOwe': 'Você ainda deve {amount} pra galera. Acerte no "Saldos" antes de sair.',
  'leaveGroup.ownerOthersOpenPre': 'Ainda tem gente com saldo aberto nesse rolê. Se você sair agora, o admin passa pra',
  'leaveGroup.ownerOthersOpenPost': '— ele fica responsável por cobrar e acertar com a galera.',
  'leaveGroup.ownerOthersOpenHasAdmin': 'Ainda tem gente com saldo aberto nesse rolê. Se você sair agora, quem já é admin fica responsável por cobrar e acertar com a galera.',
  'leaveGroup.leaveAndTransfer': 'Sair e passar admin pra {name}',
  'leaveGroup.chooseOtherAdmin': 'Prefiro escolher outro admin',
  'leaveGroup.aloneBefore': 'Você é o único no rolê. Ao sair, o rolê é',
  'leaveGroup.aloneBold': 'apagado de vez',
  'leaveGroup.aloneAfter': '— o histórico some pra sempre.',
  'leaveGroup.leaveAndDelete': 'Sair e apagar o rolê',
  'leaveGroup.ownerAllQuietPre': 'Todo mundo tá quite. Ao sair, o admin passa pra',
  'leaveGroup.ownerAllQuietPost': 'e o rolê continua ativo pra galera.',
  'leaveGroup.ownerAllQuietHasAdmin': 'Todo mundo tá quite. Ao sair, o rolê continua ativo pra galera e quem já é admin cuida dele.',
  'leaveGroup.memberOkExplain': 'Você tá quite com a galera. Ao sair, esse rolê some da sua lista, mas continua ativo pros outros participantes.',
  'leaveGroup.leaveFailedTitle': 'Não deu pra sair do rolê',
  'leaveGroup.nextParticipantFallback': 'o próximo participante',
  'leaveGroup.nextPersonFallback': 'a próxima pessoa',

  'member.roleAdmin': 'admin do rolê',
  'member.roleMember': 'participante',
  'member.makeAdmin': 'Tornar admin do rolê',
  'member.removeAdmin': 'Remover admin',
  'member.removeFromGroup': 'Remover do rolê',
  'member.removeBlockedHint': 'Não dá pra remover com saldo pendente. Acertem antes.',
  'member.confirmMakeAdminTitle': 'Tornar {name} admin do rolê',
  // Sem "Ele(a)": o título do sheet já tem o nome da pessoa, e a barra é
  // linguagem de formulário.
  'member.confirmMakeAdminBody': 'Vai poder editar o rolê, convidar e remover participantes.',
  ...
  'member.confirmRemoveAdminBody': 'Segue no rolê, mas vira participante comum.',
  'member.removeAdminFailedTitle': 'Não deu pra remover admin',
  'member.confirmRemoveTitle': 'Remover {name} do rolê',
  ...
  'qrScanner.hint': 'Aponta a câmera pro QR Code do rolê',

  'inviteQr.title': 'Convidar pro rolê',
  ...
  'joinRole.title': 'Entrar em um rolê',
  'joinRole.codeTitle': 'Código de convite',
  'joinRole.scanHint': 'Aponta a câmera pro QR code de um rolê pra entrar na hora.',
  'joinRole.openCamera': 'Abrir câmera',
  'joinRole.haveCode': 'Tenho um código de convite',
  'joinRole.enterCodeHint': 'Digita o código que a galera do rolê te passou.',
  'joinRole.codePlaceholder': 'K3M9X2P',
  'joinRole.submit': 'Entrar no rolê',
  'joinRole.backToQr': 'Voltar pro QR code',
  'joinRole.notFoundBody': 'Esse código não é de nenhum rolê. Confere e tenta de novo.',
  'joinRole.joinFailedBody': 'Confere o código e tenta de novo.',

  'batch.explain': 'Junta tudo que rola com cada pessoa em todos os rolês. Toca no WhatsApp e a mensagem já vai pronta.',
  'batch.receiveTab': 'Receber ({count})',
  'batch.payTab': 'Pagar ({count})',
  'batch.remaining': 'RESTAM {amount}',
  'batch.groupsSubtitle': '{count} rolês · {names}',
  'batch.groupsSubtitleSingular': '{count} rolê · {name}',
  'batch.resolveFailedTitle': 'Não deu pra concluir',
  'batch.resolveFailedBody': 'Alguns rolês podem não ter sido marcados. Tenta de novo.',
  // O card da Carteira não mostra rolê nenhum — este texto é o único lugar
  // onde dá pra ver o que a marcação some.
  'batch.undoTitle': 'Desfazer a marcação',
  'batch.undoBodySingular': 'Isso apaga a marcação de pagamento do rolê "{names}" — o que você deve pro {name} volta como estava.',
  'batch.undoBody': 'Isso apaga a marcação de pagamento de {count} rolês ({names}) — o que você deve pro {name} volta como estava.',
  'batch.undoProofSuffix': ' O comprovante que você anexou vai junto.',
  'batch.undoing': 'Desfazendo...',
  'batch.receberMessage': 'Oi {name}! Fechando os rolês:\n{bullets}\nTotal: {total}\n\nQuando der, manda o comprovante 🙏',
  'batch.pagarMessage': 'Oi {name}! Fechando os rolês com você:\n{bullets}\nTotal: {total}\n\nJá te aviso assim que tiver pago!',
  ...
  'settle.noExpensesNotice': 'Esse rolê não tem nenhuma despesa lançada — esses valores vêm de um pagamento já confirmado, provavelmente de uma despesa que foi apagada depois.',
  'settle.noExpensesTag': 'Sem despesa no rolê — vem de um pagamento anterior',
  ...
  'settle.msgDebtorMarkedPaid': 'Oi {name}! Acabei de te mandar {amount} do rolê. Dá uma olhadinha e confirma aí quando cair? 🙌',
  'settle.msgDebtorPending': 'Oi {name}! Vou te pagar {amount} do rolê "{group}" 💸 Combino contigo por aqui.',
  'settle.msgCreditorMarkedPaid': 'Oi {name}! Vi que você marcou o pagamento de {amount} do rolê. Vou dar uma conferida e já confirmo por aqui.',
  'settle.msgCreditorPending': 'E aí, {name}! Ainda ficou faltando {amount} do rolê "{group}" 😄 Vou te passar como você pode acertar!',
  ...
  'whatsappSheet.explain': 'A gente usa esse número pra abrir o WhatsApp direto quando alguém do rolê for te cobrar. Nunca aparece na lista de participantes.',
  ...
  'nameSheet.explain': 'É como você aparece pra todo mundo dos seus rolês — na lista de participantes, nas despesas e nos acertos.',
  'nameSheet.nameLabel': 'Seu nome',
  'nameSheet.placeholder': 'Como te chamam',
  'nameSheet.saveFailedTitle': 'Não deu pra salvar o nome',

  'pixSheet.explain': 'A gente mostra essa chave pra quem te deve, no card de acertar contas, e manda ela junto quando você cobrar pelo WhatsApp. Só quem divide rolê com você vê.',
  ...
  'voice.groupNotFound': 'Não deu pra confirmar o rolê.',
  ...
  'limitPaywall.genericEyebrow': 'Recurso Bros+',
  'limitPaywall.titleSuffix': 'com Bros+',
  'limitPaywall.rolesTitle': 'Rolês ilimitados',
  'limitPaywall.rolesSubtitle': 'Já tem 5 rolês rolando. Libera ilimitado com o Bros+.',
  'limitPaywall.voiceTitle': 'Lançar despesa com IA',
  'limitPaywall.voiceSubtitle': 'Fala o valor e a IA registra tudo. Perfeito no meio do rolê.',
  ...
  'limitPaywall.exportSubtitle': 'Baixa PDF ou CSV com tudo que rolou no rolê.',
  'limitPaywall.recurringTitle': 'Despesas que repetem',
  'limitPaywall.recurringSubtitle': 'Lança uma vez e o Bros repete pra você.',
  'limitPaywall.generalTitle': 'Desbloqueie tudo',
  'limitPaywall.generalSubtitle': 'Assina o Bros+ e libera todos os recursos do app.',
  'limitPaywall.benefit1': 'Rolês ilimitados',
  'limitPaywall.benefit1Desc': 'Cria e participa de quantos rolês quiser',
  ...
  'limitPaywall.benefit5': 'Exportar insights do rolê',
  'limitPaywall.benefit5Desc': 'Baixa PDF ou CSV com tudo que rolou',
  'limitPaywall.benefit6': 'Toda a atividade do rolê',
  'limitPaywall.benefit6Desc': 'Cada movimento em ordem, sem perder nada',
  'limitPaywall.benefit7': 'Sempre tem atualização',
  'limitPaywall.benefit7Desc': 'Todo recurso novo do Bros+, assim que for lançado',
  'limitPaywall.benefit8': 'Despesas que repetem',
  'limitPaywall.benefit8Desc': 'Lança uma vez e o Bros repete — todo dia, semana, mês ou ano',
  'limitPaywall.cta': 'Assinar Bros+',
  'limitPaywall.dismiss': 'Agora não',
  'paywall.notAvailableYet': 'A assinatura ainda não está disponível no app.',
  'paywall.title': 'Assine o [Bros+]',
  'paywall.subtitle': 'Tudo o que o Bros oferece, mais todos os recursos do Bros+.',
  ...
  'paywall.trialDay0Desc': 'Libera tudo do Bros+ na hora',
  ...
  'groupDetail.fallbackName': 'Rolê',
  'groupDetail.loadErrorTitle': 'Não deu pra carregar esse rolê.',
  ...
  'groupDetail.archiveFailedTitle': 'Não deu pra atualizar o rolê',
  'groupDetail.archiveNotSettledTitle': 'Acerta as contas antes de arquivar',
  'groupDetail.archiveNotSettledBody': 'Você ainda tem saldo pendente (ou um acerto esperando confirmação) nesse rolê. Acerta isso antes de arquivar.',
  // Sem "?": neste sheet o título NOMEIA a ação, o corpo explica e o botão
  // confirma — igual a "Sair do rolê". A pergunta era herança do Alert, onde o
  // título tinha que carregar a decisão sozinho.
  'groupDetail.archiveConfirmTitle': 'Arquivar rolê',
  ...
  'groupDetail.statTotal': 'Total do rolê',
  'groupDetail.statReceivable': 'A receber',
  'groupDetail.statPayable': 'A pagar',
  'groupDetail.expenseCountSingular': '{count} despesa registrada nesse rolê.',
  'groupDetail.expenseCountPlural': '{count} despesas registradas nesse rolê.',
  ...
  'groupDetail.expensesEmptyDefaultSubtitle': 'Toca no + pra lançar a primeira despesa do rolê.',
  ...
  'offline.gateBody': 'O BROS precisa de conexão pra funcionar. Assim que a internet voltar, você continua de onde parou.',
  ...
  'groupDetail.balanceLegend': 'Positivo = tem a receber. Negativo = tá devendo pro rolê.',
  ...
  'history.upgradeCta': 'Assine o Bros+ pra ver o histórico completo',
  ...
  'history.titleMemberJoined': '{actor} entrou no rolê',
  'history.detailMemberJoined': 'Pelo link de convite',
  'history.titleMemberLeftSelf': '{member} saiu do rolê',
  'history.detailMemberLeftSelf': 'Saiu por conta própria',
  'history.titleMemberLeftRemoved': '{member} foi removido do rolê',
  ...
  'history.titleGroupEdited': '{actor} editou o rolê',
  ...
  'history.titleGroupCreated': '{actor} criou o rolê',
  ...
  'expenseDetail.couponLabel': 'CUPOM BROS',
  ...
  'expenseDetail.deleteConfirmBody': '"{title}" ({amount}) vai sumir pra todo mundo do rolê. Não dá pra desfazer.',
  'expenseDetail.deleteLastExpenseWarningTitle': 'Essa é a última despesa do rolê — depois de apagar, ele fica sem nenhuma. Mas:',
  ...
  'expenseDetail.deleteSeriesContinues': 'Esta despesa faz parte de uma repetição, e ela continua: a próxima vai ser lançada normalmente. Só quem criou a repetição ou um admin do rolê pode pará-la.',
  ...
  'insight.loadErrorTitle': 'Não deu pra carregar os dados deste rolê.',
  ...
  'insight.exportPdfDesc': 'Bom pra mandar no zap ou salvar o fechamento do rolê.',
  ...
  'saldoDetail.balanceLabel': 'Saldo no rolê',
  ...
  'saldoDetail.chargeMessage': 'Oi {name}! Você deve *{amount}* no rolê 🙏',
  'saldoDetail.payMessage': 'Oi {name}! Vou te pagar *{amount}* do rolê 🙏',
  ...
  'saldoDetail.removeConfirmBody': 'Remover {name} do rolê?',
  ...
  'saldoDetail.removeFromGroup': 'Remover do rolê',

  'groupDetail.archiving': 'Arquivando...',
  'groupDetail.archiveBlockedReceivable': 'Você ainda tem {amount} pra receber nesse rolê. Pede pra galera acertar antes de arquivar.',
  'groupDetail.archiveRecurrenceWarnTitle': 'AINDA TÁ REPETINDO',
  'groupDetail.archiveRecurrenceWarnSingular': 'Este rolê tem 1 despesa que se repete e inclui você. Ela continua sendo lançada depois de arquivado, e seu saldo vai voltar a mexer.',
  'groupDetail.archiveRecurrenceWarnPlural': 'Este rolê tem {count} despesas que se repetem e incluem você. Elas continuam sendo lançadas depois de arquivado, e seu saldo vai voltar a mexer.',
  ...
  // Presente, não passado: a lista do rolê narra uma despesa que JÁ aconteceu
  ...
  'participants.statusEven': 'quite com o rolê',
  'participants.statusReceivable': 'tem a receber {amount}',
  'participants.statusOwing': 'tá devendo {amount}',
  'participants.leaveGroup': 'Sair do rolê',
  'participants.leaveLegendOwner': 'Você só pode sair se o seu saldo estiver zerado. Se você for o único admin, quem entrou primeiro vira admin no seu lugar. O rolê só é apagado se você for o único participante.',
  ...
  'onboarding.welcomeSubtitle': 'Em 3 toques a gente monta seu primeiro rolê pra você sentir como o Bros funciona. Sem cadastro ainda.',
  'onboarding.welcomeItem1': 'Monte um rolê do seu jeito',
  ...
  'onboarding.typeTitle': 'Que tipo de rolê é o seu?',
  'onboarding.typeSubtitle': 'A gente usa isso pra sugerir um nome e montar os exemplos com a cara do seu rolê.',
  ...
  // não acha a opção. Escolher aqui já deixa o rolê com esse padrão
  ...
  'onboarding.nameViagem': 'Rolê da praia',
  'onboarding.nameRepublica': 'Nossa casa',
  'onboarding.nameGalera': 'Rolê da galera',
  'onboarding.nameOutro': 'Meu primeiro rolê',
  'onboarding.voiceBadge': 'Bros+',
  ...
  'onboarding.resultSubtitleEqual': 'Foi igual — o Bros já sabe quem paga o quê.',
  'onboarding.resultSubtitleExact': 'Cada um com o que consumiu — o Bros já sabe quem paga o quê.',
  'onboarding.resultSubtitleShares': 'Você entrou com o dobro — o Bros já sabe quem paga o quê.',
  ...
  'login.cardCopy': 'Divida contas com seus\nparças sem drama',
  ...
  'errors.loadGroupsFailed': 'Erro ao carregar rolês',
  'errors.loadGroupFailed': 'Erro ao carregar rolê',
  ...
  'groups.alreadyInGroup': 'Você já está nesse rolê.',
  'groups.invalidCodeInput': 'Digita um código de rolê válido.',
  'groups.codeNotFound': 'Esse código não corresponde a nenhum rolê.',
